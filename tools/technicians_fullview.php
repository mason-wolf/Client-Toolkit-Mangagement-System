...
?>
	...
	<div class="kitTitle">Technicians</div>
   ...
   <tr>
    <td style="overflow: hidden; width: 150px; text-align: left; valign: top; whitespace: nowrap;">
     ...
     <?php echo $Report['LastName'] . ", " . $Report['FirstName'] ?> </td>   
     
     <td><?php echo $Report['AssignedKit'];?></td> 
    <td><?php echo $Report['InspectionDate'];?></td>
	<td style="float:right;"></td>
    <td style="float:right;"><a href="Profile.php?technician=<?php echo $Report["LastName"]; ?>">View</a></td>
   </tr>
	...
	$paginateQuery = "SELECT * FROM users";
