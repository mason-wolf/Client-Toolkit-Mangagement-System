...
$noInventory = "No inventory available.";
}

?>
<?php include('Header.php'); ?>
<div class="inventory">
<?php if(isset($noInventory)) { ?><center style="margin-top:10px;"><?php echo $noInventory; } else {?></center><?php
include('Inventory_QuickView.php');
}
?>
</div>
<div class="technicians">
<?php include('Technicians_QuickView.php'); ?>
</div>
<div class="reports">
